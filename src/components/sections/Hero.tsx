      ...
      <Container className="flex flex-col lg:flex-row gap-10 lg:gap-12">
        ...
        >
          ...
          <Paragraph className="mt-8">
            Let's bring Crypto to Everyone with our Referrals where we offer up
            to 90% Cashback on every trade and up to 50% of Discounts with
            trading Fees!
          </Paragraph>
            ...
            <div className="flex sm:flex-row flex-col gap-2 w-full">
              <form
                ...
                className="py-1 pl-6 w-full pr-1 flex gap-3 items-center text-heading-3
                                          ...
                                          bg-body rounded-full ease-linear focus-within:bg-body
        ...
        <div className="flex flex-1 lg:w-1/2 lg:h-auto relative lg:max-w-none lg:mx-0 mx-auto max-w-4xl">
          <img
            src="/src/assets/istock.png"
            alt="Hero image"
            width={3000}
            height={3000}
            className="lg:absolute lg:w-full lg:h-full rounded-4xl object-cover lg:max-h-none max-h-[600px]"
          />
        </div>
      </Container>
      <Numbers />
