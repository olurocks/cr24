      ...
      <Container>
        <nav className="flex items-center justify-between gap-6 w-full">
          ...
          <div className="flex items-center gap-4 py-1">
            ...
            <button
              onClick={toggleTheme}
              className="flex items-center justify-center w-8 h-8 rounded-full border border-box-border text-heading-2 transform transition duration:300 hover:[scale:1.2] cursor-pointer transition-colors"
